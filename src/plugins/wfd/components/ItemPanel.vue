  ...
  <div class="itemPanel">
    <el-collapse v-model="activeNames" accordion>
      <el-collapse-item :title="i18n['start']" name="1">
        ...
        <img alt="image" data-item="{clazz:'timerStart',size:'30*30',label:''}"
             :src="require('../assets/flow/timer-start.svg')" style="width:42px;height:42px"/>
        <div>{{ i18n['timerEvent'] }}</div>
        <img alt="image" data-item="{clazz:'messageStart',size:'30*30',label:''}"
      ...
      <el-collapse-item :title="i18n['gateway']" name="3">
        ...
        <img alt="image" data-item="{clazz:'parallelGateway',size:'40*40',label:''}"
      ...
      <el-collapse-item :title="i18n['catch']" name="4">
        ...
        <div>{{ i18n['timerEvent'] }}</div>
        <img alt="image" data-item="{clazz:'messageCatch',size:'50*30',label:''}"
