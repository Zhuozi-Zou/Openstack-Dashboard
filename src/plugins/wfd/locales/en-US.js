export default {
  ...
  'phy.name': 'Name',
  'phy.id': 'ID',
  'phy.project_id': 'Project ID',
  'phy.status': 'Status',
  'phy.admin_state_up': 'Admin State',
  'phy.shared': 'Shared',
  'phy.router:external': 'External Network',
  'phy.mtu': 'MTU',
  'phy.provider': 'Provider Network',
  'phy.provider:network_type': 'Network Type',
  'phy.provider:physical_network': 'Physical Network',
  'phy.provider:segmentation_id': 'Segmentation ID',
  router: 'Router',
  'router.name': 'Name',
  'router.id': 'ID',
  'router.description': 'Description',
  'router.project_id': 'Project ID',
  'router.status': 'Status',
  'router.admin_state_up': 'Admin State',
  'router.availability_zones': 'Availability Zones',
  network: 'Network',
  subnet: 'Subnet',
  instance: 'Instance',
